package jesty.lib.logging;

import java.util.Objects;
import java.util.concurrent.Callable;
import java.util.function.Supplier;

import jesty.lib.Delay;
import jesty.lib.DynVar;
import jesty.lib.function.EntryConsumer;
import jesty.lib.string.NonBlank;
import jesty.lib.string.Str;
